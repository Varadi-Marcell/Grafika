...
{ 
	...
	load_model(&(wall->cube_wall), "cube2.obj");
	wall->wall_texture = load_texture("volley.png"); 
	
	load_model(&(wall->cel), "coin.obj");
	wall->cel_texture = load_texture("piros.png"); 
	
	load_model(&(wall->start), "coin.obj");
	wall->start_texture = load_texture("piros.png");
    ...
    scene->material.shininess = 0.0;
	 ...
	 load_model(&(myobject->cube), "volleyball.obj");
    myobject->cube_texture_id = load_texture("volley2.png"); 
...
void goal(Wall* wall,MyObject* myobject)
{
	...
	switch (temp)
        {
        case 0 ... 3:
			wall->cel_texture = load_texture("zold.png");
			wall->start_texture = load_texture("sarga.png");
            myobject->speed=0;
	...
	switch (temp)
        {
        case 0 ... 3:
			wall->start_texture = load_texture("zold.png");
            myobject->speed=0;
			myobject->position.x=-48;
